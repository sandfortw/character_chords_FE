...
RSpec.describe Playlist do
  let(:playlist_data) { {:links=>{:image=>"https://media.npr.org/assets/img/2022/07/22/bcs_609_gl_1005_0864-rt_wide-c958ce0b1e351340c63e2f5823f499afe3fbf840-s1600-c85.webp"},
  :data=>
   {:type=>"playlist",
    :genre=>"hip-hop",
    :id=>"1",
