...
RSpec.describe Character do
   let(:character_data) { {:links=>{:image=>"https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Roy_Cohn.jpg/463px-Roy_Cohn.jpg"},
   :data=>{:type=>"character", :theme_id=>1, :attributes=>{:name=>"Roy Cohn", :quiz=>"lawyer", :alignment=>"Lawful Evil", description: "A description"}}} }
